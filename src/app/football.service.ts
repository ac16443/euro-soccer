...
import { environment } from '../environmentes/environment.prod';
import {
...
export class FootballService {
  ...
  leagueStandingResponse: LeagueStandingResponse = {
    get: 'standings',
    parameters: {
      league: '39',
      season: '2023',
  ...
  getStandings(
    ...
    //return of(this.leagueStandingResponse);
  ...
  getTeamResults(teamId: number): Observable<FixtureResponse> {
    // return of(this.fixtureResponse);
